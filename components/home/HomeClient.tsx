...
import { reviews } from '@/lib/data' // Keep reviews static for now or fetch later
...
interface HomeClientProps {
    villas: any[] // Using any for flexibility, but ideally matches VillaCardProps['villa']
}

export default function HomeClient({ villas }: HomeClientProps) {
    return (
                ...
                <div className="container-premium">
                    ...
                    {villas.length > 0 ? (
                        ...
                        <div className="text-center py-20 bg-neutral-50 rounded-lg">
                            <p className="text-neutral-500">No villas currently available. Check back soon.</p>
                        </div>
                    )}
                </div>
            </section>
